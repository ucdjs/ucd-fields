...
export interface CaseFolding {
  ...
  mapping: string | string[]; // The case folding mapping for the character, which may be a single character or an array of characters for full case folding
...
export interface EastAsianWidth {
  ...
  east_asian_width: "N" | "A" | "H" | "W" | "F" | "Na"; // The East Asian Width property of the character, indicating its width classification.
}
...
export interface NamedSequencesProv {
  ...
  code_point_sequence: string; // The code point sequence for the named sequence in Unicode Standard.
}
...
export interface StandardizedVariants {
  variation_sequence: string; // The standardized variation sequence defined in the Unicode Standard.
