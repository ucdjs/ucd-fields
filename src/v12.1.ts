...
export interface CjkRadicals {
  cjk_radical_number: string; // The CJK radical number, which may end with an apostrophe.
...
export interface EquivalentUnifiedIdeograph {
  equivalent_unified_ideograph: "none" | string; // The equivalent unified ideograph for the specified code point, or none if no equivalent exists.
  code_point: string; // The code point or code point range represented as a variable-length hexadecimal value.
  mapped_code_point: string; // The code point represented as a variable-length hexadecimal value that is equivalent to the specified code point.
}
...
export interface IndicPositionalCategory {
  unicode_code_point: string; // Unicode code point value or range of code point values
  indic_positional_category: string; // Indic_Positional_Category property value
...
export interface PropertyAliases {
  short_name: string; // The short name for the property, typically an abbreviation or a longer string for Unihan database tags.
...
export interface ScriptExtensions {
  ...
  code_point: string; // The code point associated with the Script_Extensions value.
}
...
export interface USourceData {
  ...
  status: "A" | "B" | "C" | "D" | "E" | "F" | "G" | "N" | "U" | "UNC-2013" | "UNC-2015" | "UK-2015" | "V" | "W" | "WS-2017" | "X" | "UTC-xxxxx" | "UCI-xxxxx"; // Indicates the ideograph's status regarding encoding and submission
...
export interface VerticalOrientation {
  ...
  vertical_orientation: "U" | "R" | "Tu" | "Tr"; // Vertical orientation property value, indicating the orientation of the character in vertical text layout
}
