...
export interface PropertyValueAliases {
  ...
  short_name: string
  long_name: string
  canonical_combining_class: number | string | string[]
  aliases: string[]
}
...
export interface USourceData {
  u_source_id: string
  status: "A" | "B" | "C" | "D" | "E" | "F" | "G" | "N" | "U" | "UNC-2013" | "UNC-2015" | "UK-2015" | "V" | "W" | "WS-2017" | "X" | "UTC-xxxxx" | "UCI-xxxxx"
  unicode_code_point: string
...
export interface DerivedLineBreak {
  derived_line_break_version: string
  date: string
  copyright: string
  unicode_character_database: string
}
