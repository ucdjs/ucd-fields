...
export interface BidiMirroring {
  bidi_mirroring_glyph: string; // The code point of a character that has a mirrored glyph.
  code_point: string; // The original code point represented as a variable-length hexadecimal value.
...
export interface EastAsianWidth {
  ...
  east_asian_width_property: "N" | "A" | "H" | "W" | "F" | "Na"; // The East Asian Width property of the character, indicating its width classification.
}
...
export interface IndicMatraCategory {
  code_point: string; // The code point or code point range of a character.
  indic_matra_category: string; // The Indic Matra Category, which defines the category of dependent vowels and viramas.
}
...
export interface LineBreak {
  ...
  line_break_property: "BK" | "CR" | "LF" | "CM" | "SG" | "GL" | "CB" | "SP" | "ZW" | "NL" | "WJ" | "JL" | "JV" | "JT" | "H2" | "H3" | "XX" | "OP" | "CL" | "CP" | "QU" | "NS" | "EX" | "SY" | "IS" | "PR" | "PO" | "NU" | "AL" | "ID" | "IN" | "HY" | "BB" | "BA" | "SA" | "AI" | "B2" | "HL" | "CJ"; // The line break property of the character, which can be one of several normative or informative values.
}
...
export interface SpecialCasing {
  ...
  condition_list: string[]; // An optional list of conditions that override normal behavior, defined by language IDs or contexts
...
export interface DerivedBidiClass {
  derived_bidi_class: string; // The derived bidirectional class of a character as defined in Unicode.
