...
export interface BidiMirroring {
  bidi_mirroring_glyph: "none" | string; // The mapping for the Bidi_Mirroring_Glyph property, which can be none or a specific character's code point.
  code_point: string; // The code point of a character, represented as a hexadecimal value.
  comment: string; // Comments indicating where the characters are 'BEST FIT' mirroring.
}
...
export interface CaseFolding {
  ...
  status: "C" | "F" | "S" | "T"; // The status of the mapping, indicating the type of case folding
...
export interface EquivalentUnifiedIdeograph {
  equivalent_unified_ideograph: "none" | string; // The equivalent CJK unified ideograph for the specified code point, or none if no equivalent exists.
  code_point: string; // The code point or code point range represented as a variable-length hexadecimal value.
  comment: string; // Comments regarding CJK radicals and strokes that do not have equivalent unified ideographs.
}
...
export interface NamedSequencesProv {
  name_of_sequence: string; // The name of the Unicode named character sequence.
  code_point_sequence: string[]; // A sequence of code points corresponding to the named character sequence.
}
...
export interface ScriptExtensions {
  script_extensions: string[]; // A set of one or more abbreviated Script property values associated with characters.
...
export interface USourceData {
  ...
  status: "A" | "B" | "C" | "D" | "E" | "F" | "G" | "N" | "U" | "UNC-2013" | "UNC-2015" | "UK-2015" | "V" | "W" | "WS-2017" | "X" | "UTC-xxxxx" | "UCI-xxxxx"; // Indicates the ideograph's status, including encoding extensions and submission statuses
