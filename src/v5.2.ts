...
export interface LineBreak {
  unicode_value: string; // The Unicode value of the character, represented in hexadecimal form.
  line_break_property: "BK" | "CR" | "LF" | "CM" | "SG" | "GL" | "CB" | "SP" | "ZW" | "NL" | "WJ" | "JL" | "JV" | "JT" | "H2" | "H3" | "XX" | "OP" | "CL" | "CP" | "QU" | "NS" | "EX" | "SY" | "IS" | "PR" | "PO" | "NU" | "AL" | "ID" | "IN" | "HY" | "BB" | "BA" | "SA" | "AI" | "B2"; // The line break property of the character, which can be normative or informative.
}
...
export interface NameAliases {
  code_point: string; // The code point of a Unicode character, in hexadecimal form
...
export interface NamedSequences {
  name_of_sequence: string; // The name of the Unicode sequence.
  code_point_sequence: string; // The sequence of code points for the Unicode sequence.
}
...
export interface NamedSequencesProv {
  ...
  code_point_sequence: string; // The code point sequence for the named sequence.
}
