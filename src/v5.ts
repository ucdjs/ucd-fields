...
export interface SpecialCasing {
  ...
  condition_list: string[]; // Optional list of conditions that override normal behavior, represented as locale IDs or contexts
...
export interface DerivedBidiClass {
  ...
  date: string; // The date when the file was created or last modified.
