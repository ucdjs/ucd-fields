...
export interface BidiMirroring {
  bidi_mirroring_glyph: "none" | string; // The Bidi_Mirroring_Glyph property for each code point, indicating the mirrored glyph or none if not applicable.
  code_point: string; // The code point of a character, represented as a variable-length hexadecimal value.
...
export interface CaseFolding {
  ...
  mapping: string | string[]; // The case folding mapping for the character, which may be a single character or multiple characters for full case folding
...
export interface LineBreak {
  unicode_code_point: string; // Unicode code point value or range of code point values
  line_break_property: "BK" | "CM" | "CR" | "GL" | "LF" | "NL" | "SP" | "WJ" | "ZW" | "ZWJ" | "AI" | "AL" | "B2" | "BA" | "BB" | "CB" | "CJ" | "CL" | "CP" | "EB" | "EM" | "EX" | "H2" | "H3" | "HL" | "HY" | "ID" | "IN" | "IS" | "JL" | "JT" | "JV" | "NS" | "NU" | "OP" | "PO" | "PR" | "QU" | "RI" | "SA" | "SG" | "SY" | "XX"; // Line_Break property, indicating how line breaks should be handled for the given code point
}
...
export interface NameAliases {
  ...
  type: "correction" | "control" | "alternate" | "figment" | "abbreviation"; // The type of alias, indicating its category as defined in the documentation
}
...
export interface SpecialCasing {
  ...
  condition_list: string[]; // A list of conditions that override the normal behavior, represented as language IDs or casing contexts
...
export interface USourceData {
  ...
  status: "C" | "D" | "E" | "F" | "H" | "N" | "U" | "UNC-2013" | "UNC-2015" | "UK-2015" | "V" | "W" | "X" | "UTC-xxxxx" | "UCI-xxxxx"; // Text indicating the ideograph's status
