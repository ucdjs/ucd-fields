...
export interface BidiBrackets {
  ...
  bidi_paired_bracket_type: "o" | "c" | "n"; // Bidi_Paired_Bracket_Type property value, indicating Open, Close, or None
}
...
export interface EquivalentUnifiedIdeograph {
  equivalent_unified_ideograph: string; // The property that defines the equivalent unified ideograph for a given code point or code point range.
  ...
  default_value: "none" | string; // The default value of the Equivalent_Unified_Ideograph property, which is 'none' unless a mapping is specified.
}
...
export interface IndicPositionalCategory {
  unicode_code_point: string; // Unicode code point value or range of code point values
  indic_positional_category: string; // Indic Positional Category property value, indicating the positional relationship of characters in Indic scripts.
}
...
export interface LineBreak {
  unicode_code_point: string; // Unicode code point value or range of code point values
  line_break_property: "BK" | "CM" | "CR" | "GL" | "LF" | "NL" | "SP" | "WJ" | "ZW" | "ZWJ" | "AI" | "AK" | "AL" | "AP" | "AS" | "B2" | "BA" | "BB" | "CB" | "CJ" | "CL" | "CP" | "EB" | "EM" | "EX" | "H2" | "H3" | "HL" | "HY" | "ID" | "IN" | "IS" | "JL" | "JT" | "JV" | "NS" | "NU" | "OP" | "PO" | "PR" | "QU" | "RI" | "SA" | "SG" | "SY" | "VF" | "VI" | "XX"; // Line_Break property, indicating how line breaking should be handled for the code point
}
...
export interface NamedSequences {
  ...
  code_point_sequence: string[]; // The sequence of code points corresponding to the named character sequence, represented as an array of strings.
}
...
export interface ScriptExtensions {
  ...
  code_point: string; // The code point associated with the Script_Extensions value, listed in code point order.
}
...
export interface USourceData {
  ...
  status: "Comp" | "ExtA" | "ExtB" | "ExtC" | "ExtD" | "ExtE" | "ExtF" | "ExtG" | "ExtH" | "ExtI" | "FutureWS" | "NoAction" | "Rejected" | "URO" | "Variant" | "WS-2021" | "UTC-xxxxx" | "UCI-xxxxx"; // Status of the ideograph encoding
  ...
  total_strokes_property: number; // kTotalStrokes property value (see UAX #38)
...
export interface DerivedName {
  unicode_code_point: string; // Unicode code point value or range of code point values
  name_property_value: string; // Name property value or pattern derived from the code point
}
...
export interface EmojiData {
  ...
  comments: string; // Comments or additional information about the emoji character
}
...
export interface EmojiVariationSequences {
  name: string; // The name of the emoji variation sequence.
  emoji_variation_sequence: string; // The sequence of emoji characters that represent the variation.
  variation_selector: string; // The variation selector used to indicate the specific variation of the emoji.
}
